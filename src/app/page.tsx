  ...
  const projects = [
    {
      ...
      challenge: 'Managing real-time bids from multiple users without data conflicts.',
      solution: 'Used Socket.io for real-time communication and optimized backend logic to ensure consistent bid updates.',
    ...
    },
    {
      ...
      challenge: 'Generating meaningful interview questions dynamically using AI.',
      solution: 'Integrated the OpenAI API to generate context-aware questions and structured feedback.',
    ...
    },
    {
      ...
      challenge: 'Maintaining consistent cart state across multiple screens.',
      solution: 'Implemented Provider for centralized state management across the application.',
    ...
    },
    {
      ...
      challenge: 'Providing fast recipe search while keeping favorite recipes stored locally.',
      solution: 'Used AsyncStorage to persist favorite recipes and optimized API calls for faster search results.',
    ...
    },
    {
      ...
      challenge: 'Handling authentication and dynamic content loading efficiently.',
      solution: 'Used Firebase Authentication and structured API calls to dynamically fetch and render movie data.',
    ...
    },
    {
      ...
      challenge: 'Fetching and displaying accurate weather data with minimal delay.',
      solution: 'Integrated OpenWeatherMap API and optimized request handling for fast updates.',
